...
public class GModelBuilder {
   private static final String filePath = "C:/Users/Rajasree/eclipse-workspace/Project1030-ZestType-Balak/src/input-graph-info.txt";
   ...
   public GModelBuilder buildByGraphInfoFile() {
      ...
      for (String iNodeName : nodeNames) {
         ...
         if (getNodeType(iNodeName).equals("A")) {
            // TODO: Class Exercise
            gNode = new GNodeTypeA(getNodeId(iNodeName), iNodeName );
         } else if (getNodeType(iNodeName).equals("B")) {
            // TODO: Class Exercise
        	 gNode = new GNodeTypeB(getNodeId(iNodeName), iNodeName );
         } else if (getNodeType(iNodeName).equals("C")) {
            // TODO: Class Exercise
        	 gNode = new GNodeTypeC(getNodeId(iNodeName), iNodeName );
         } else {
      ...
      for (String[] iConn : connectionInfo) {
         ...
         //TODO: Class Exercise
         if(nodeSrc.getConnectedTo().add(nodeDst)) {
