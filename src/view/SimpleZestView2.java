...
public class SimpleZestView2 {
   private GraphViewer gViewer;
   private int layout = 1;
   public static final String SIMPLEZESTVIEW_ID = "project1030-zesttype-balak.partdescriptor.simplezestview-type-1030-balak";
   public static final String SIMPLEVIEW_ID = "project1030-zesttype-balak.partdescriptor.simpleview";
   public static final String POPUPMENU_ID = "project1030-zesttype-balak.popupmenu.mypopup";
   ...
   public void createControls(Composite parent, EMenuService menuService) {
      ...
      gViewer.setInput(GModelBuilder.instance().buildByGraphInfoFile().getNodes());
